...
<body>
	...
	<div class="row">
		...
		<div>
			...
			<form action="admin_lawyer_filter.php" method="post">
	
				<center>

					<input type="text" name="search" placeholder="search lawyer" required="true" />
...
if($mysql->connect_error)
{
	...
	if ($result = $mysql->query("SELECT * FROM lawyer"))
	{
