...
<body>
	...
	<tr>
		<td>	<input type="password" id="stu_pswd" name="stu_pswd" placeholder="Password">
		<p id="perror"> </p>
			</td>
	...
	<script>
		...
		<td><p class="move-text">Not Register?<a href="user_register.php">&nbsp Sign Up</a> here</p> </td>
		</tr>
