...
<body>
	...
	<tr>	
	<td class="form_head">law title </td>
	<td><input type="text" name="law_title"  id="clg_name" placeholder="law title">
		<p id="nerror"></p></td>
			</tr>
	...
	<tr>	
	<td class="form_head">law section</td>
	<td><input type="text" name="law_section" id="clg_city" placeholder="law section ">
	<p id="cierror"></p></td>
			</tr>
	...
	<tr>
		...
		<td> 
			<input type="submit" value="Add Law" onclick="return validate()"></td>
		<script>
		function validate(){
