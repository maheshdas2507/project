...
<body>
	...
	<div>
			...
			<form action="admin_law_filter.php" method="post">
	
				<center>

					<input type="text" name="search law" placeholder="search" required="true" />
...
if($mysql->connect_error)
{
	...
	if ($result = $mysql->query("SELECT * FROM law"))
	{
